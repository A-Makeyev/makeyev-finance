    ...
    education: {
      movingChecklist: {
        ...
        sections: {
          ...
          meters: {            title: 'צילום מונים ביום המעבר',
            items: [
          ...
          deposits: {
            title: 'ביטחונות',
            items: [
              'אחרי וידוא שלא נותרו חובות, יש להחזיר את הביטחונות לשוכר הקודם.',
            ],
          },
        },
        timing:
      ...
      prepaymentPenalty: {
        ...
        whyPrime: 'ההבדל נובע מכך שמסלול פריים כבר צמוד לריבית המשתנה של בנק ישראל, ולכן אין לבנק רווח עתידי שננעל בהסכם ופירעון מוקדם שולל ממנו אותו. במסלול בריבית קבועה הבנק התחייב לריבית קבועה לשנים, ופירעון מוקדם כשהריבית בשוק ירדה שולל ממנו את הפער.',
        timing: 'לפני פירעון מוקדם כדאי לבקש מהבנק פירוט עמלות בכתב, ולבדוק מתי מועד עדכון הריבית של המסלול ~ לעיתים המתנה קצרה למועד העדכון חוסכת את כל העמלה.',
        disclaimer: 'המידע כללי ואינו תלוי בנתוני החישוב שלכם, ואינו מהווה ייעוץ או הצעה. גובה העמלה נקבע בהסכם ההלוואה ובכפוף להוראות בנק ישראל.',
